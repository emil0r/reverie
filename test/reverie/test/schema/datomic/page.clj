...
(fact
 ...
 (let [{:keys [connection]} (setup)
       ...
       tmp (rev/object-set! obj connection obj-id {:reverie/area :a})
...
(fact
 ...
 (let [{:keys [connection]} (setup)
       ...
       tmp (rev/object-set! obj connection obj-id1 {:reverie/area :a :reverie/order 1 :text "obj-1"})
       tmp (rev/object-set! obj connection obj-id2 {:reverie/area :a :reverie/order 2 :text "obj-2"})
...
(fact
 ...
 (let [{:keys [connection]} (setup)
       ...
       tmp (rev/object-set! obj connection obj-id1 {:reverie/area :a :reverie/order 1 :text "obj-1"})
       tmp (rev/object-set! obj connection obj-id2 {:reverie/area :a :reverie/order 2 :text "obj-2"})
       tmp (rev/object-set! obj connection obj-id3 {:reverie/area :a :reverie/order 3 :text "obj-3"})
       tx-rdata2 (rev/page-new-object! (assoc tx-rdata :object-id obj-id1))
       tx-rdata3 (rev/page-new-object! (assoc tx-rdata :object-id obj-id2))
